...
urlpatterns = [
    ...
    path('delete_purchase_order/<int:pk>', views.DeletePurchaseOrderView.as_view(), name='delete-purchase-order'),
    path('update_purchase_order/<int:pk>', views.UpdatePurchaseOrderView.as_view(), name='update-purchase-order'),
